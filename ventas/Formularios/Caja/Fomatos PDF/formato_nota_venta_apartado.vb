...
Module formato_nota_venta_apartado
    Public Sub Generar_Formato_venta_apartado(ByVal id_venta As Integer)
        'Tryn
        'Intentar generar el documento.
        Dim doc As New Document(PageSize.LETTER, 30, 40, 20, 45)

        Dim filename As String = global_dir_facturas + "\NOTA_VENTA_" & Format(id_venta, "0000") & ".pdf"
    ...
    Public Sub Generar_pagina(ByVal document As Document, ByVal writer As PdfWriter, ByVal id_venta As Integer)
        ...
        rs.Open("SELECT venta.fecha,venta.id_cliente,venta.desc_global_porcent,venta.desc_global_importe,CONCAT(persona.nombre,' ',persona.ap_paterno,' ',persona.ap_materno) AS empleado_venta,venta.total,venta.status " & _
        ...
        NOTA.SetWidthPercentage({60, 40, 100, 120, 80, 55, 50, 50, 50}, PageSize.LETTER)
        ...
        A4.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        A4.MinimumHeight = 15
        A4.Colspan = 2
        ...
        A6.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        A6.Colspan = 3
        ...
        Dim C4 As New PdfPCell(New Paragraph("www.mueblika.com", FontFactory.GetFont("Arial", 9, Font.NORMAL)))
        C4.MinimumHeight = 15
        C4.Border = Nothing
        C4.Colspan = 2
        ...
        C6.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        C6.Colspan = 3
        C6.HorizontalAlignment = Element.ALIGN_CENTER
        NOTA.AddCell(C6)

        Dim D4 As New PdfPCell(New Paragraph("Facebook: MueblikaEvolution", FontFactory.GetFont("Arial", 8, Font.NORMAL)))
        D4.MinimumHeight = 15
        D4.Border = Nothing
        D4.Colspan = 2
        ...
        Dim E1 As New PdfPCell(New Paragraph("Mk1 Orizaba: Oriente 6 esq. Sur 25 #1340 Col. Centro Orizaba, Ver. C.P. 94300 Tel  01(272) 72-44-327 email: mueblika _ori@live.com.mx" & vbCrLf & _
"Mk2 Boca del Río: Calza Costa Verde #674 Col. Fracc. Costa Verde Boca del Río, Ver. C.P. 94294 Tel. 01(229)937 32 34 email: mk2booca@live.com.mx " & vbCrLf & _
"Mk3 Coatzacoalcos: Av. Ignacio Zaragoza #1300 esq. Matamoros Col. Centro Coatzacoalcos, Ver. C.P. 96420 Tel. 01 (921) 163-03-61 email:muebli-kacoatza@live.com " & vbCrLf & _
"Mk4 Xalapa: Bolivia #53 - B Col. Francisco I. Madero Xalapa, Ver. C.P. 91070 Tel. 01(228)812-21-23 email:mk_4ventas@live.com " & vbCrLf & _
"MK5 Oaxaca:  Calzada Niños Héroes de Chapultepec  811. Col. Reforma. Oaxaca de Juárez, Oaxaca. CP. 68050 Tel 01(951) 132-4805 e mail : mueblikaevolution@gmail.com", FontFactory.GetFont("Arial", 6, Font.NORMAL)))
        E1.Border = Nothing
        E1.Colspan = 7
        E1.MinimumHeight = 50
        ...
        Dim E7 As New PdfPCell(New Paragraph(" " & vbCrLf & _
                                             "Horario:" & vbCrLf & _
                                             " " & vbCrLf & _
                                             "Lunes a Domingo " & vbCrLf & _
                                             " " & vbCrLf & _
                                             "11:00 a 21:00 hrs", FontFactory.GetFont("Arial", 8, Font.NORMAL)))
        E7.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        E7.Border = Nothing
        E7.Colspan = 2
        E7.MinimumHeight = 60
        ...
        Dim J1 As New PdfPCell(New Paragraph("ASESOR DE VENTAS:", FontFactory.GetFont("Arial", 8, Font.BOLDITALIC)))
        J1.Border = Nothing
        J1.MinimumHeight = 15
        J1.PaddingTop = 10
        J1.PaddingBottom = 10
        ...
        Dim J4 As New PdfPCell(New Paragraph("MODALIDAD DE COMPRA:", FontFactory.GetFont("Arial", 8, Font.BOLDITALIC)))
        J4.Border = Nothing
        J4.PaddingTop = 10
        J4.PaddingBottom = 10
        J4.Colspan = 2
        ...
        Dim K1 As New PdfPCell(New Paragraph("PROMOCION:", FontFactory.GetFont("Arial", 7, Font.BOLDITALIC)))
        K1.Border = Nothing
        K1.MinimumHeight = 15
        K1.PaddingBottom = 10
        ...
        Dim K1B As New PdfPCell(New Paragraph("__________", FontFactory.GetFont("Arial", 7, Font.NORMAL)))
        K1B.Border = Nothing
        ...
        Dim K3 As New PdfPCell(New Paragraph("COSTO DE SERV. ENTREGA", FontFactory.GetFont("Arial", 7, Font.BOLDITALIC)))
        K3.PaddingBottom = 10
        K3.Border = Nothing
        K3.HorizontalAlignment = Element.ALIGN_LEFT
        NOTA.AddCell(K3)

        Dim K4 As New PdfPCell(New Paragraph("__________", FontFactory.GetFont("Arial", 7, Font.NORMAL)))
        K4.Border = Nothing
        K4.PaddingBottom = 10
        K4.HorizontalAlignment = Element.ALIGN_LEFT
        NOTA.AddCell(K4)

        Dim K5 As New PdfPCell(New Paragraph("TIEMPO DE APARTADO", FontFactory.GetFont("Arial", 7, Font.BOLDITALIC)))
        K5.Colspan = 2
        K5.Border = Nothing
        K5.PaddingBottom = 10
        ...
        Dim K6 As New PdfPCell(New Paragraph(tiempo_apartado, FontFactory.GetFont("Arial", 7, Font.UNDERLINE)))
        K6.Border = Nothing
        K6.PaddingBottom = 10
        K6.Colspan = 2
        ...
        Dim L4 As New PdfPCell(New Paragraph("TAPIZ/INSCRUSTACION.", FontFactory.GetFont("Arial", 5, Font.BOLD)))
        L4.BorderWidthRight = 0
        L4.BorderWidthBottom = 1
        L4.BorderWidthLeft = 0
        L4.BorderWidthTop = 1
        L4.PaddingTop = 5
        L4.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        L4.HorizontalAlignment = Element.ALIGN_CENTER
        NOTA.AddCell(L4)

        Dim L5 As New PdfPCell(New Paragraph("CODIGO PRODUCTO", FontFactory.GetFont("Arial", 8, Font.BOLD)))
        L5.BorderWidthRight = 0.1
        L5.BorderWidthBottom = 1
        L5.BorderWidthLeft = 0.1
        L5.BorderWidthTop = 1
        L5.PaddingTop = 5
        L5.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        L5.Colspan = 2
        L5.HorizontalAlignment = Element.ALIGN_CENTER
        NOTA.AddCell(L5)

        Dim L6 As New PdfPCell(New Paragraph("P.PROMOCION", FontFactory.GetFont("Arial", 8, Font.BOLD)))
        L6.BorderWidthRight = 1
        L6.BorderWidthBottom = 1
        L6.BorderWidthLeft = 0.1
        L6.BorderWidthTop = 1
        L6.PaddingTop = 5
        L6.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        L6.Colspan = 2
        ...
        If rs.RecordCount > 0 Then
            While Not rs.EOF
                ...
                Dim P1 As New PdfPCell(New Paragraph(rs.Fields("cantidad").Value, FontFactory.GetFont("Arial", 7, Font.NORMAL)))
                ...
                Dim P1B As New PdfPCell(New Paragraph(rs.Fields("descripcion").Value, FontFactory.GetFont("Arial", 7, Font.NORMAL)))
                ...
                Dim P5 As New PdfPCell(New Paragraph(rs.Fields("codigo").Value, FontFactory.GetFont("Arial", 7, Font.NORMAL)))
                ...
                Dim P6 As New PdfPCell(New Paragraph(FormatCurrency(rs.Fields("importe").Value), FontFactory.GetFont("Arial", 7, Font.NORMAL)))
        ...
        Dim S1 As New PdfPCell(New Paragraph("FORMA DE PAGO: (DEL ENGANCHE)", FontFactory.GetFont("Arial", 8, Font.BOLDITALIC)))
        S1.Colspan = 2
        S1.MinimumHeight = 20
        ...
        Dim S3 As New PdfPCell(New Paragraph("ENGANCHE: ", FontFactory.GetFont("Arial", 8, Font.BOLDITALIC)))
        ...
        Dim U1 As New PdfPCell(nota_venta_01)
        ...
        Dim U2 As New PdfPCell(New Paragraph("- Guarda tu nota de venta" & vbCrLf & _
                                             "- Solicita regalo en:" & vbCrLf & _
                                             "cuentaleagmi@live.com" & vbCrLf & _
                                             "- Califica nuestro servicio y" & vbCrLf & _
                                             "llevate un TABURETE ¡Gratis!" & vbCrLf & _
                                             "en tu proxima compra", FontFactory.GetFont("Arial", 6, Font.NORMAL)))
        ...
        Dim V1 As New PdfPCell(New Paragraph("Atencion a clientes", FontFactory.GetFont("Arial", 7, Font.BOLD)))
        ...
        V1.MinimumHeight = 15
        V1.PaddingTop = 5
        V1.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        V1.MinimumHeight = 25
        V1.Colspan = 2
        V1.HorizontalAlignment = Element.ALIGN_CENTER
        NOTA.AddCell(V1)

        Dim V2 As New PdfPCell(New Paragraph("Tel. 01(222) 144-55-16 email: gmi_atencionaclientes@live.com.mx " & vbCrLf & _
                                             "Whatsapp:227 63 64 71", FontFactory.GetFont("Arial", 7, Font.BOLD)))
        V2.BorderWidthRight = 0.1
        V2.BorderWidthBottom = 1
        V2.BorderWidthLeft = 0.1
        V2.BorderWidthTop = 0.1
        V2.PaddingLeft = 10
        V2.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        V2.Colspan = 3
        ...
        Dim W1 As New PdfPCell(New Paragraph("I M P O R T A N T E", FontFactory.GetFont("Arial", 7, Font.BOLD)))
        W1.Border = Nothing
        W1.Colspan = 5
        ...
        Dim X1 As New PdfPCell(New Paragraph("- TODA MERCANCIA TENDRA QUE SER LIQUIDAD EN LA SUCURSAL PARA SER ENTREGA" & vbCrLf & _
                                             "- ENTREGADA LA MERCANCIA NO SE ADMITEN CAMBIOS NI DEVOLUCIONES." & vbCrLf & _
                                             "- EN CASO DE CANCELACION SE COBRARA EL 25 % DE PENALIZACION DEK TOTAL DE LA NOTA DE VENTA." & vbCrLf & _
                                             "- PARA REALIZAR EL DE PEDIDO DE UN PRODUCTO TIENE QUE ESTAL LIQUIDADO EL 70% DE LA MERCANCIA." & vbCrLf & _
                                             "- TIEMPO DE ENTREGA 30 DIAS HABILES A PARTIR DE REALIZAR EL PEDIDO." & vbCrLf & _
                                             "- PARA EFECTOS DE GARANTIA ES RESPONSABILIDAD DE CLIENTE LLEVAR  Y RECOGER EL PRODUCTO A LA SUCURSAL DONDE FUE ADQUIRIDO.", FontFactory.GetFont("Arial", 6, Font.ITALIC)))
        X1.Border = Nothing
        X1.Colspan = 5
        X1.MinimumHeight = 40
        ...
        X5.BorderWidth = 1
        X5.BackgroundColor = New BaseColor(System.Drawing.Color.FromArgb(-2565928))
        X5.Colspan = 2
        X5.MinimumHeight = 40
        X5.PaddingTop = 15
