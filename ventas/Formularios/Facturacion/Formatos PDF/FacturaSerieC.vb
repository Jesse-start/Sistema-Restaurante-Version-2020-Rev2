...
Module FacturaSerieC
    Public Sub GenerarFacturaSerieC(ByVal id_factura As Integer, ByVal concepto_general As Boolean, ByVal cadena_concepto As String)
        'Tryn
        ...
        rs.Close()
        'conn.close()
        Dim filename As String = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\FACTURAS-SERIEC\FACTURA-" & num & " SERIEC.pdf"
        Dim file As New FileStream(filename, FileMode.Create, FileAccess.Write, FileShare.ReadWrite)
        Dim writer As PdfWriter = PdfWriter.GetInstance(doc, file)
        doc.Open()
        ExportarDatosPDF_SerieC(doc, writer, id_factura, concepto_general, cadena_concepto)
        doc.Close()
    ...
    Public Function GetColumnasSize(ByVal dg As DataGridView) As Single()
        ...
        Return values
    End Function
    Public Sub ExportarDatosPDF_SerieC(ByVal document As Document, ByVal writer As PdfWriter, ByVal id_factura As Integer, ByVal concepto_general As Boolean, ByVal cadena_concepto As String)
        '=========================================================================
        ...
        Dim serie As New PdfPCell(New Paragraph("SERIE C", ArialMT13))
        serie.Colspan = 2
        ...
        If concepto_general Then
            Dim codigo001 As New PdfPCell(New Paragraph("C1", Futuran10))
        ...
        Dim codigo_seriec As iTextSharp.text.Image
        codigo_seriec = iTextSharp.text.Image.GetInstance(Application.StartupPath & "\SERIE_C.png")
        codigo_seriec.ScaleAbsoluteWidth(80) 'Ancho de la imagen
        codigo_seriec.ScaleAbsoluteHeight(80) 'Altura de la imagen

        Dim codigo_bidimensional As New PdfPCell(codigo_seriec)
        ...
        Dim linea4 As New PdfPCell(New Paragraph("HERNANDEZ|FACTURAS|C|1|50|24246852|27/11/2012", ArialMT8))
        linea4.Colspan = 5
        linea4.BorderColor = BaseColor.WHITE
        Tablatotales.AddCell(linea4)

        Dim linea5 As New PdfPCell(New Paragraph("18:31:47|APROBACIÓN|00001000000010000001|", ArialMT8))
        linea5.Colspan = 3
        ...
        Dim linea6 As New PdfPCell(New Paragraph("NUMERO DE APROBACION SICOFI 24246852", ArialMT7))
        linea6.Colspan = 3
        linea6.PaddingTop = 6
