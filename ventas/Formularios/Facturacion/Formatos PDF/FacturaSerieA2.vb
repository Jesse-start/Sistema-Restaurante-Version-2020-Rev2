...
Module FacturaSerieA2
    Public Sub GenerarFacturaSerieA2(ByVal id_factura As Integer, ByVal concepto_general As Boolean, ByVal cadena_concepto As String)
        'Tryn
        ...
        rs.Close()
        'conn.close()
        Dim filename As String = global_dir_facturas + "\FACTURA-" & num & " SERIEA.pdf"
        Dim file As New FileStream(filename, FileMode.Create, FileAccess.Write, FileShare.ReadWrite)
        Dim writer As PdfWriter = PdfWriter.GetInstance(doc, file)
        doc.Open()
        ExportarDatosPDF_SerieA(doc, writer, id_factura, concepto_general, cadena_concepto)
        doc.Close()
    ...
    Public Function GetColumnasSize(ByVal dg As DataGridView) As Single()
        ...
        Return values
    End Function
    Public Sub ExportarDatosPDF_SerieA(ByVal document As Document, ByVal writer As PdfWriter, ByVal id_factura As Integer, ByVal concepto_general As Boolean, ByVal cadena_concepto As String)
        '=========================================================================
        ...
        Dim serie As New PdfPCell(New Paragraph("SERIE A", ArialMT13))
        serie.Colspan = 2
        ...
        If concepto_general Then
            Dim codigo001 As New PdfPCell(New Paragraph("A1", Futuran10))
            ...
            Dim precio001 As New PdfPCell(New Paragraph(_subtotal, Futuran9))
        ...
        Else
            ...
            If rs.RecordCount > 0 Then
                ...
                While Not rs.EOF
                    ...
                    Dim precio001 As New PdfPCell(New Paragraph(Replace(FormatCurrency(rs.Fields("precio_unitario").Value), "$", ""), Futuran9))
                    precio001.PaddingTop = 5
                    precio001.PaddingBottom = 5
                    precio001.PaddingRight = 5
                    precio001.HorizontalAlignment = Element.ALIGN_RIGHT
        ...
        codigo_seriea = iTextSharp.text.Image.GetInstance(Application.StartupPath & "\SERIE_A2.png")
        codigo_seriea.ScaleAbsoluteWidth(80) 'Ancho de la imagen
        codigo_seriea.ScaleAbsoluteHeight(80) 'Altura de la imagen
        ...
        Dim linea4 As New PdfPCell(New Paragraph("HERNANDEZ|FACTURAS|A|301|800|25000754|27/04/2013", ArialMT8))
        linea4.Colspan = 5
        linea4.BorderColor = BaseColor.WHITE
        Tablatotales.AddCell(linea4)

        Dim linea5 As New PdfPCell(New Paragraph("14:02:09|APROBACIÓN|00001000000010000001|", ArialMT8))
        linea5.Colspan = 3
        ...
        Dim linea6 As New PdfPCell(New Paragraph("NÚMERO DE APROBACIÓN SICOFI 25000754", ArialMT7))
        linea6.Colspan = 3
        linea6.PaddingTop = 6
