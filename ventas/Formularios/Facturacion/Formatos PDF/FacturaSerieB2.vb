...
Module FacturaSerieB2
    Public Sub GenerarFacturaSerieB2(ByVal id_factura As Integer, ByVal concepto_general As Boolean, ByVal cadena_concepto As String)
        'Tryn
    ...
    Public Sub ExportarDatosPDF_SerieB(ByVal document As Document, ByVal writer As PdfWriter, ByVal id_factura As Integer, ByVal concepto_general As Boolean, ByVal cadena_concepto As String)
        ...
        If concepto_general Then
            ...
            Dim precio001 As New PdfPCell(New Paragraph(_subtotal, Futuran09))
        ...
        Else
            ...
            If rs.RecordCount > 0 Then
                ...
                While Not rs.EOF
                    ...
                    Dim precio001 As New PdfPCell(New Paragraph(Replace(FormatCurrency(rs.Fields("precio_unitario").Value), "$", ""), Futuran09))
                    precio001.PaddingTop = 5
                    precio001.PaddingBottom = 5
                    precio001.PaddingRight = 5
                    precio001.HorizontalAlignment = Element.ALIGN_RIGHT
        ...
        codigo_serieb = iTextSharp.text.Image.GetInstance(Application.StartupPath & "\SERIE_B2.png")
        ...
        Dim linea4 As New PdfPCell(New Paragraph("HERNANDEZ|FACTURAS|B|101|500|25328463|18/07/2013", ArialMT8))
        linea4.Colspan = 5
        linea4.BorderColor = BaseColor.WHITE
        Tablatotales.AddCell(linea4)

        Dim linea5 As New PdfPCell(New Paragraph("09:47:16|APROBACIÓN|00001000000010000001|", ArialMT8))
        linea5.Colspan = 3
        ...
        Dim linea6 As New PdfPCell(New Paragraph("NUMERO DE APROBACIÓN SICOFI 25328463", ArialMT7))
        linea6.Colspan = 3
        linea6.PaddingTop = 6
